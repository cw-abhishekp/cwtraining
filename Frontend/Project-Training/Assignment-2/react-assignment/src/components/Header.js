    ...
    <header className="main-header">
      ...
      <div className="header-right">
        <span className="icon-btn">
          {/* <svg width="24" height="24" fill="none" stroke="#555" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/><circle cx="18" cy="6" r="2" fill="#ff4d1c"/></svg> */}
        ...
        <span className="icon-btn">
          {/* <svg width="24" height="24" fill="none" stroke="#555" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 8-4 8-4s8 0 8 4"/></svg> */}
