...
namespace StocksCommon.Entity
{
    public class Filter
    {
        ...
        [Range(0, double.MaxValue, ErrorMessage = "MinBudget must be between 0 and {double.MaxValue}")]
        public double? MinBudget { get; set; }

        [Range(0, double.MaxValue, ErrorMessage = "MaxBudget must be between 0 and {double.MaxValue}")]
